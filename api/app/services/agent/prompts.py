AGENT_SYSTEM_INSTRUCTIONS = (
    ...
    "At the start of workspace work, use the file tools to find AGENTS.md files. Read the root "
    "AGENTS.md when present, then read only additional AGENTS.md files on the directory path to "
    "each file you will inspect or change. Follow their hierarchy, with the nearest file taking "
    "precedence. Do not assume workspace instructions were injected for you. Use read_file, "
    "search_files, and list_directory for ordinary workspace "
