export const en = {
  ...
  settings: {
    ...
    profileEyebrow: "IDENTITY", profileTitle: "Personal profile", profileDescription: "Manage your OhMyCode identity.", save: "Save profile", saved: "Saved", profileSaved: "Profile saved.", saveFailed: "Settings could not be saved.", changeAvatar: "Change avatar", avatarInvalid: "Choose a PNG, JPEG, or WebP image up to 5 MB.",
