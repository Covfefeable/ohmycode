export const en = {
  common: { cancel: "Cancel", close: "Close", save: "Save", edit: "Edit", delete: "Delete", confirmDelete: "Confirm deletion", deleteWarning: "This action cannot be undone.", copy: "Copy", copied: "Copied", code: "Code", networkError: "Network error. Check your connection and try again.", retry: "Retry" },
  window: {
    minimize: "Minimize",
  ...
  agent: {
    ...
    description:
      "Select a workspace and describe your task. The Agent will take care of the rest.",
    ...
    branchFailed: "The conversation branch could not be created.",
    ...
    diffTooLarge: "This file is too large to display its diff here.",
  ...
  multiAgent: {
    ...
    host: "Host",
    hostDescription: "Understands the goal, schedules members, and summarizes to the user when needed",
  ...
  settings: {
    eyebrow: "PREFERENCES", title: "Settings", profileTab: "Personal profile", modelsTab: "Model configurations", backgroundTasksTab: "Background tasks", mcpTab: "MCP", skillsTab: "Skills", updatesTab: "Check for updates", loadFailed: "The settings could not be loaded.",
    profileEyebrow: "IDENTITY", profileTitle: "Personal profile", profileDescription: "Manage your OhMyCode identity.", save: "Save profile", saved: "Saved", profileSaved: "Profile saved.", saveFailed: "Settings could not be saved.", avatarStorageUnavailable: "The avatar storage service is unavailable. Check the MinIO configuration and try again.", changeAvatar: "Change avatar", avatarInvalid: "Choose a PNG, JPEG, or WebP image up to 5 MB.",
    ...
    backgroundTasksTitle: "Background tasks", backgroundTasksDescription: "Configure automatic summaries, context compaction, and follow-up suggestions.", saveBackgroundTasks: "Save background tasks", backgroundTasksSaved: "Background task settings saved.", enabled: "Enabled", disabled: "Disabled", autoSummary: "Automatic summaries", autoSummaryTooltip: "Automatically summarize historical conversation information to improve context structure and save tokens in long tasks.", autoSummaryModel: "Summary model", contextCompactionThreshold: "Context compaction threshold", contextCompactionModel: "Context compaction model", suggestions: "Follow-up suggestions", suggestionsModel: "Suggestion model",
    ...
    updatesTitle: "Check for updates", updatesDescription: "Check GitHub Releases for a newer OhMyCode version.", checkForUpdates: "Check for updates", checkingForUpdates: "Checking", updateCheckingHint: "Connecting to GitHub to retrieve the latest version.", updateAvailable: "Update available", updateAvailableHint: "OhMyCode {{version}} is available on GitHub.", upToDate: "OhMyCode is up to date", upToDateHint: "There are no newer releases available.", updateCheckFailed: "Update check failed", updateCheckFailedHint: "GitHub could not be reached. Check your network and try again.", openGitHubRelease: "Open download", currentVersion: "Current version", latestVersion: "Latest version", releaseDate: "Release date",
