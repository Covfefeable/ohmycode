export const en = {
  ...
  settings: {
    eyebrow: "PREFERENCES", title: "Settings", profileTab: "Personal profile", modelsTab: "Model configurations", mcpTab: "MCP", skillsTab: "Skills", loadFailed: "The settings could not be loaded.",
