export const en = {
  ...
  multiAgent: {
    ...
    nodeInstructionsPlaceholder: "Describe this agent's responsibilities and completion criteria. Type / to reference an MCP tool or Skill…",
  ...
  settings: {
    eyebrow: "PREFERENCES", title: "Settings", profileTab: "Personal profile", modelsTab: "Model configurations", backgroundTasksTab: "Background tasks", mcpTab: "MCP", skillsTab: "Skills", loadFailed: "The settings could not be loaded.",
