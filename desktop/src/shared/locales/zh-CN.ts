export const zhCN = {
  ...
  agent: {
    eyebrow: "本地代码 AGENT",
    heading: "你想构建什么？",
    description: "选择一个工作区，然后描述任务。Agent 帮你完成。",
    ...
    you: "你",
    branch: "创建分支",
    branchCreated: "分支会话已创建。",
    branchFailed: "分支会话创建失败。",
    ...
    readFile: "已读取",
    editedFile: "已编辑",
    originalContent: "原来的内容",
    currentContent: "现在的内容",
    diffTooLarge: "文件过大，无法在此处展示差异。",
    loadingDiff: "正在加载差异…",
  ...
  multiAgent: {
    ...
    teamMembers: "协作成员",
    host: "主持人",
    hostDescription: "负责理解目标、调度成员，并在需要时向用户汇总",
  ...
  settings: {
    eyebrow: "偏好设置", title: "设置", profileTab: "个人信息", modelsTab: "模型配置", backgroundTasksTab: "背景任务", mcpTab: "MCP", skillsTab: "Skills", updatesTab: "检查更新", loadFailed: "设置加载失败。",
    ...
    backgroundTasksTitle: "背景任务", backgroundTasksDescription: "配置自动摘要、上下文压缩和下一步建议。", saveBackgroundTasks: "保存背景任务", backgroundTasksSaved: "背景任务设置已保存。", enabled: "开启", disabled: "关闭", autoSummary: "自动摘要", autoSummaryTooltip: "自动摘要历史对话信息，在长任务下可以优化上下文结构，节省 Token。", autoSummaryModel: "自动摘要模型", contextCompactionThreshold: "压缩上下文阈值", contextCompactionModel: "压缩上下文模型", suggestions: "下一步建议", suggestionsModel: "下一步建议模型",
    ...
    updatesTitle: "检查更新", updatesDescription: "检查 GitHub Releases 中可用的 OhMyCode 新版本。", checkForUpdates: "检查更新", checkingForUpdates: "正在检查", updateCheckingHint: "正在连接 GitHub 获取最新版本。", updateAvailable: "发现新版本", updateAvailableHint: "OhMyCode {{version}} 已发布，可前往 GitHub 下载。", upToDate: "当前已是最新版本", upToDateHint: "暂时没有可用的新版本。", updateCheckFailed: "检查更新失败", updateCheckFailedHint: "无法连接 GitHub，请检查网络后重试。", openGitHubRelease: "前往下载", currentVersion: "当前版本", latestVersion: "最新版本", releaseDate: "发布日期",
