...
export const styles = StyleSheet.create({
  ...
  deleteAction: { alignItems: "center", bottom: 0, gap: spacing[1], justifyContent: "center", position: "absolute", right: 0, top: 0, width: spacing[8] * 2.5 },
  deleteText: { fontSize: typography.xs, fontWeight: "700" },
  ...
  error: { fontSize: typography.xs, paddingHorizontal: spacing[3], paddingVertical: spacing[2] },
  ...
  swipeContainer: { borderRadius: radii.medium, overflow: "hidden" },
});
